...
public class SynchronizedMethodExample {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Thread thread1 = new SynchronizedMethodThread(criticalResource);
		Thread thread2 = new SynchronizedMethodThread(criticalResource);
	...
	private static class MySharedResource {
		public synchronized void doSomethingOnCriticalResource(String threadName) {
	...
	@AllArgsConstructor
	private static class SynchronizedMethodThread extends Thread  {
